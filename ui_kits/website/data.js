...
(function () {
  ...
  window.SR_DATA = {
    ...
    // El enlace web del perfil. En Android ya abre la app en el salón (App Links);
    // en iOS/escritorio abre la web. Un mismo enlace para todos los dispositivos.
    bookingUrl: function () { return this.booksyUrl; },
